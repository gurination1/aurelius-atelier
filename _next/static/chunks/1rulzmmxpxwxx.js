(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,56504,e=>{"use strict";e.s(["t",0,function(e){return"object"==typeof e&&!!e&&!Array.isArray(e)}])},446205,328368,e=>{"use strict";var t=Object.defineProperty,r=(e,r)=>{let i={};for(var n in e)t(i,n,{get:e[n],enumerable:!0});return r||t(i,Symbol.toStringTag,{value:"Module"}),i};e.s(["t",0,r],328368);var i=e.i(56504),n=r({fromString:()=>p,get:()=>d,isIndexSegment:()=>l,isIndexTuple:()=>u,isKeySegment:()=>c,reKeySegment:()=>a,toString:()=>f});let o=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,a=/_key\s*==\s*['"](.*)['"]/,s=/^\d*:\d*$/;function l(e){return"number"==typeof e||"string"==typeof e&&/^\[\d+\]$/.test(e)}function c(e){return"string"==typeof e?a.test(e.trim()):"object"==typeof e&&"_key"in e}function u(e){if("string"==typeof e&&s.test(e))return!0;if(!Array.isArray(e)||2!==e.length)return!1;let[t,r]=e;return("number"==typeof t||""===t)&&("number"==typeof r||""===r)}function d(e,t,r){let i="string"==typeof t?p(t):t;if(!Array.isArray(i))throw Error("Path must be an array or a string");let n=e;for(let e=0;e<i.length;e++){let t=i[e];if(l(t)){if(!Array.isArray(n))return r;n=n[t]}if(c(t)){if(!Array.isArray(n))return r;n=n.find(e=>e._key===t._key)}if("string"==typeof t&&(n="object"==typeof n&&n?n[t]:void 0),void 0===n)return r}return n}function f(e){if(!Array.isArray(e))throw Error("Path is not an array");return e.reduce((e,t,r)=>{let i=typeof t;if("number"===i)return`${e}[${t}]`;if("string"===i)return`${e}${0===r?"":"."}${t}`;if(c(t)&&t._key)return`${e}[_key=="${t._key}"]`;if(Array.isArray(t)){let[r,i]=t;return`${e}[${r}:${i}]`}throw Error(`Unsupported path segment \`${JSON.stringify(t)}\``)},"")}function p(e){if("string"!=typeof e)throw Error("Path is not a string");let t=e.match(o);if(!t)throw Error("Invalid path string");return t.map(h)}function h(e){return l(e)?Number(e.replace(/[^\d]/g,"")):c(e)?{_key:e.match(a)[1]}:u(e)?function(e){let[t,r]=e.split(":").map(e=>""===e?e:Number(e));return[t,r]}(e):e}let g="drafts",m="versions",v=`${g}.`,b=`${m}.`;function y(e){return e.startsWith(v)}function w(e){return e.startsWith(b)}function x(e){return!y(e)&&!w(e)}function E(e){if(!w(e))return;let[t,r,...i]=e.split(".");return r}function $(e){if(w(e))return e.split(".").slice(2).join(".");if(y(e))return e.slice(v.length);if(x(e))return e;throw Error(`Unable to resolve a published id from "${e}"`)}let T={"\f":"\\f","\n":"\\n","\r":"\\r","	":"\\t","'":"\\'","\\":"\\\\"},S={"\\f":"\f","\\n":"\n","\\r":"\r","\\t":"	","\\'":"'","\\\\":"\\"};function A(e){return`$${e.map(e=>"string"==typeof e?`['${e.replace(/[\f\n\r\t'\\]/g,e=>T[e])}']`:"number"==typeof e?`[${e}]`:""===e._key?`[${e._index}]`:`[?(@._key=='${e._key.replace(/['\\]/g,e=>T[e])}')]`).join("")}`}function I(e){let t=[],r=/\['(.*?)'\]|\[(\d+)\]|\[\?\(@\._key=='(.*?)'\)\]/g,i;for(;null!==(i=r.exec(e));){if(void 0!==i[1]){let e=i[1].replace(/\\(\\|f|n|r|t|')/g,e=>S[e]);t.push(e);continue}if(void 0!==i[2]){t.push(parseInt(i[2],10));continue}if(void 0!==i[3]){let e=i[3].replace(/\\(\\')/g,e=>S[e]);t.push({_key:e,_index:-1});continue}}return t}function _(e){return e.map(e=>{if("string"==typeof e||"number"==typeof e)return e;if(""!==e._key)return{_key:e._key};if(-1!==e._index)return e._index;throw Error(`invalid segment:${JSON.stringify(e)}`)})}function R(e){return e.map(e=>{if("string"==typeof e||"number"==typeof e)return e;if(-1!==e._index)return e._index;throw Error(`invalid segment:${JSON.stringify(e)}`)})}function j(e,t){if(!t?.mappings)return;let r=A(R(e));if(void 0!==t.mappings[r])return{mapping:t.mappings[r],matchedPath:r,pathSuffix:""};let i=R(e).map(e=>"string"==typeof e?`['${e.replace(/[\f\n\r\t'\\]/g,e=>T[e])}']`:"number"==typeof e?`[${e}]`:""===e._key?`[${e._index}]`:`[?(@._key=='${e._key.replace(/['\\]/g,e=>T[e])}')]`);for(let e=i.length-1;e>=0;e--){let n=`$${i.slice(0,e).join("")}`,o=t.mappings[n];if(o)return{mapping:o,matchedPath:n,pathSuffix:r.substring(n.length)}}}function k(e){let t="string"==typeof e?e:e.baseUrl;return"/"!==t&&(t=t.replace(/\/$/,"")),"string"==typeof e?{baseUrl:t}:{...e,baseUrl:t}}e.s(["S",0,f,"_",0,x,"a",0,j,"b",0,a,"c",0,I,"d",0,m,"f",0,function(e){return w(e)?v+$(e):y(e)?e:v+e},"g",0,y,"h",0,function(e,t){if("drafts"===t||"published"===t)throw Error('Version can not be "published" or "drafts"');return`${b}${t}.${$(e)}`},"i",0,function e(t,r,n=[]){if(null!==t&&Array.isArray(t))return t.map((t,o)=>{if((0,i.t)(t)){let i=t._key;if("string"==typeof i)return e(t,r,n.concat({_key:i,_index:o}))}return e(t,r,n.concat(o))});if((0,i.t)(t)){if("block"===t._type||"span"===t._type){let i={...t};return"block"===t._type?i.children=e(t.children,r,n.concat("children")):"span"===t._type&&(i.text=e(t.text,r,n.concat("text"))),i}return Object.fromEntries(Object.entries(t).map(([t,i])=>[t,e(i,r,n.concat(t))]))}return r(t,n)},"l",0,function(e){return("string"==typeof e?p(e):e).map(e=>{var t;if("string"==typeof e||"number"==typeof e)return e;if(Array.isArray(e))throw Error(`IndexTuple segments aren't supported:${JSON.stringify(e)}`);if("object"==typeof(t=e)&&"_key"in t&&"_index"in t)return e;if(e._key)return{_key:e._key,_index:-1};throw Error(`invalid segment:${JSON.stringify(e)}`)})},"m",0,E,"n",0,k,"o",0,A,"p",0,$,"r",0,function(e){let{baseUrl:t,workspace:r="default",tool:i="default",id:n,type:o,path:a,projectId:s,dataset:l}=e;if(!t)throw Error("baseUrl is required");if(!a)throw Error("path is required");if(!n)throw Error("id is required");if("/"!==t&&t.endsWith("/"))throw Error("baseUrl must not end with a slash");let c="default"===r?void 0:r,u="default"===i?void 0:i,d=$(n),p=Array.isArray(a)?f(_(a)):a,h=new URLSearchParams({baseUrl:t,id:d,type:o,path:p});if(c&&h.set("workspace",c),u&&h.set("tool",u),s&&h.set("projectId",s),l&&h.set("dataset",l),x(n))h.set("perspective","published");else if(w(n)){let e=E(n);h.set("perspective",e)}let g=["/"===t?"":t];c&&g.push(c);let m=["mode=presentation",`id=${d}`,`type=${o}`,`path=${encodeURIComponent(p)}`];return u&&m.push(`tool=${u}`),g.push("intent","edit",`${m.join(";")}?${h}`),g.join("/")},"s",0,_,"t",0,function(e){let{resultSourceMap:t,resultPath:r}=e,{mapping:i,pathSuffix:n}=j(r,t)||{};if(!i||"literal"===i.source.type||"unknown"===i.source.type)return;let o=t.documents[i.source.document],a=t.paths[i.source.path];if(o&&a){let{baseUrl:t,workspace:r,tool:i}=k("function"==typeof e.studioUrl?e.studioUrl(o):e.studioUrl);if(!t)return;let{_id:s,_type:l,_projectId:c,_dataset:u}=o;return{baseUrl:t,workspace:r,tool:i,id:s,type:l,path:I(a+n),projectId:c,dataset:u}}},"u",0,g,"v",0,w,"x",0,n,"y",0,d],446205)},204042,e=>{"use strict";var t=e.i(446205);e.s(["getPublishedId",()=>t.p])},657771,e=>{"use strict";var t=e.i(446205);e.s(["studioPath",()=>t.x])},407500,e=>{e.v(t=>Promise.all(["static/chunks/2619pqauczhjr.js"].map(t=>e.l(t))).then(()=>t(975681)))},273299,e=>{"use strict";var t;let r="image-Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000-jpg";function i(e){return`image-${e.split("/").slice(-1)[0]}`.replace(/\.([a-z]+)$/,"-$1")}let n=[["width","w"],["height","h"],["format","fm"],["download","dl"],["blur","blur"],["sharpen","sharp"],["invert","invert"],["orientation","or"],["minHeight","min-h"],["maxHeight","max-h"],["minWidth","min-w"],["maxWidth","max-w"],["quality","q"],["fit","fit"],["crop","crop"],["saturation","sat"],["auto","auto"],["dpr","dpr"],["pad","pad"],["frame","frame"]],o=["clip","crop","fill","fillmax","max","scale","min"],a=["top","bottom","left","right","center","focalpoint","entropy"],s=["format"];function l(e){let{apiHost:t,projectId:r,dataset:i}=e,n={baseUrl:(t||"https://api.sanity.io").replace(/^https:\/\/api\./,"https://cdn.")},o=e.resource??e["~experimental_resource"];if(o?.type==="media-library"){if("string"!=typeof o.id||0===o.id.length)throw Error('Media library clients must include an id in "resource"');return{...n,mediaLibraryId:o.id}}if(o?.type==="canvas"){if("string"!=typeof o.id||0===o.id.length)throw Error('Canvas clients must include an id in "resource"');return{...n,canvasId:o.id}}if(o?.type==="dataset"){if("string"!=typeof o.id||0===o.id.length)throw Error('Dataset clients must include an id in "resource"');let[e,t]=o.id.split(".");if(!e||!t)throw Error('Dataset resource id must be in the format "projectId.dataset", got: '+o.id);return{...n,projectId:e,dataset:t}}return{...n,projectId:r,dataset:i}}function c(e){return e&&"config"in e&&"function"==typeof e.config?l(e.config()):e&&"clientConfig"in e&&"object"==typeof e.clientConfig?l(e.clientConfig):e||{}}class u{options;constructor(e,t){this.options=e?{...e.options||{},...t||{}}:{...t||{}}}withOptions(e){return new u(this,function(e,t){let r=t.baseUrl||e.baseUrl,i={baseUrl:r};for(let e in t)t.hasOwnProperty(e)&&(i[function(e){for(let t of n){let[r,i]=t;if(e===r||e===i)return r}return e}(e)]=t[e]);return{baseUrl:r,...i}}(this.options,e))}image(e){return this.withOptions({source:e})}dataset(e){return this.withOptions({dataset:e})}projectId(e){return this.withOptions({projectId:e})}withClient(e){let t=c(e),r={...this.options};return delete r.baseUrl,delete r.projectId,delete r.dataset,delete r.mediaLibraryId,delete r.canvasId,new u(null,{...t,...r})}bg(e){return this.withOptions({bg:e})}dpr(e){return this.withOptions(e&&1!==e?{dpr:e}:{})}width(e){return this.withOptions({width:e})}height(e){return this.withOptions({height:e})}focalPoint(e,t){return this.withOptions({focalPoint:{x:e,y:t}})}maxWidth(e){return this.withOptions({maxWidth:e})}minWidth(e){return this.withOptions({minWidth:e})}maxHeight(e){return this.withOptions({maxHeight:e})}minHeight(e){return this.withOptions({minHeight:e})}size(e,t){return this.withOptions({width:e,height:t})}blur(e){return this.withOptions({blur:e})}sharpen(e){return this.withOptions({sharpen:e})}rect(e,t,r,i){return this.withOptions({rect:{left:e,top:t,width:r,height:i}})}format(e){return this.withOptions({format:e})}invert(e){return this.withOptions({invert:e})}orientation(e){return this.withOptions({orientation:e})}quality(e){return this.withOptions({quality:e})}forceDownload(e){return this.withOptions({download:e})}flipHorizontal(){return this.withOptions({flipHorizontal:!0})}flipVertical(){return this.withOptions({flipVertical:!0})}ignoreImageParams(){return this.withOptions({ignoreImageParams:!0})}fit(e){if(-1===o.indexOf(e))throw Error(`Invalid fit mode "${e}"`);return this.withOptions({fit:e})}crop(e){if(-1===a.indexOf(e))throw Error(`Invalid crop mode "${e}"`);return this.withOptions({crop:e})}saturation(e){return this.withOptions({saturation:e})}auto(e){if(-1===s.indexOf(e))throw Error(`Invalid auto mode "${e}"`);return this.withOptions({auto:e})}pad(e){return this.withOptions({pad:e})}vanityName(e){return this.withOptions({vanityName:e})}frame(e){if(1!==e)throw Error(`Invalid frame value "${e}"`);return this.withOptions({frame:e})}url(){return function(e){let t={...e||{}},o=t.source;delete t.source;let a=function(e){var t;let r;if(!e)return null;if("string"==typeof e&&(t=e,/^https?:\/\//.test(`${t}`)))r={asset:{_ref:i(e)}};else if("string"==typeof e)r={asset:{_ref:e}};else if(e&&"string"==typeof e._ref)r={asset:e};else if(e&&"string"==typeof e._id)r={asset:{_ref:e._id||""}};else if(e&&e.asset&&"string"==typeof e.asset.url)r={asset:{_ref:i(e.asset.url)}};else{if("object"!=typeof e.asset)return null;r={...e}}return e.crop&&(r.crop=e.crop),e.hotspot&&(r.hotspot=e.hotspot),function(e){if(e.crop&&e.hotspot)return e;let t={...e};return t.crop||(t.crop={left:0,top:0,bottom:0,right:0}),t.hotspot||(t.hotspot={x:.5,y:.5,height:1,width:1}),t}(r)}(o);if(!a){if(o&&"object"==typeof o&&null!==o&&o._upload&&(!o.asset||!o.asset._ref))return"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8HwQACfsD/QNViZkAAAAASUVORK5CYII=";throw Error(`Unable to resolve image URL from source (${JSON.stringify(o)})`)}let s=function(e){let[,t,i,n]=e.split("-");if(!t||!i||!n)throw Error(`Malformed asset _ref '${e}'. Expected an id like "${r}".`);let[o,a]=i.split("x"),s=+o,l=+a;if(!(isFinite(s)&&isFinite(l)))throw Error(`Malformed asset _ref '${e}'. Expected an id like "${r}".`);return{id:t,width:s,height:l,format:n}}(a.asset._ref||a.asset._id||""),l=Math.round(a.crop.left*s.width),c=Math.round(a.crop.top*s.height),u={left:l,top:c,width:Math.round(s.width-a.crop.right*s.width-l),height:Math.round(s.height-a.crop.bottom*s.height-c)},d=a.hotspot.height*s.height/2,f=a.hotspot.width*s.width/2,p=a.hotspot.x*s.width,h=a.hotspot.y*s.height;return t.rect||t.focalPoint||t.ignoreImageParams||t.crop||(t={...t,...function(e,t){let r,i=t.width,n=t.height;if(!(i&&n))return{width:i,height:n,rect:e.crop};let o=e.crop,a=e.hotspot,s=i/n;if(o.width/o.height>s){let e=Math.round(o.height),t=Math.round(e*s),i=Math.max(0,Math.round(o.top)),n=Math.max(0,Math.round(Math.round((a.right-a.left)/2+a.left)-t/2));n<o.left?n=o.left:n+t>o.left+o.width&&(n=o.left+o.width-t),r={left:n,top:i,width:t,height:e}}else{let e=o.width,t=Math.round(e/s),i=Math.max(0,Math.round(o.left)),n=Math.max(0,Math.round(Math.round((a.bottom-a.top)/2+a.top)-t/2));n<o.top?n=o.top:n+t>o.top+o.height&&(n=o.top+o.height-t),r={left:i,top:n,width:e,height:t}}return{width:i,height:n,rect:r}}({crop:u,hotspot:{left:p-f,top:h-d,right:p+f,bottom:h+d}},t)}),function(e){let t,r=(e.baseUrl||"https://cdn.sanity.io").replace(/\/+$/,""),i=e.vanityName?`/${e.vanityName}`:"",o=`${e.asset.id}-${e.asset.width}x${e.asset.height}.${e.asset.format}${i}`;t=e.mediaLibraryId?`${r}/media-libraries/${e.mediaLibraryId}/images/${o}`:e.canvasId?`${r}/images/canvases/${e.canvasId}/${o}`:`${r}/images/${e.projectId}/${e.dataset}/${o}`;let a=[];if(e.rect){let{left:t,top:r,width:i,height:n}=e.rect;(0!==t||0!==r||n!==e.asset.height||i!==e.asset.width)&&a.push(`rect=${t},${r},${i},${n}`)}e.bg&&a.push(`bg=${e.bg}`),e.focalPoint&&(a.push(`fp-x=${e.focalPoint.x}`),a.push(`fp-y=${e.focalPoint.y}`));let s=[e.flipHorizontal&&"h",e.flipVertical&&"v"].filter(Boolean).join("");return s&&a.push(`flip=${s}`),n.forEach(t=>{let[r,i]=t;"u">typeof e[r]?a.push(`${i}=${encodeURIComponent(e[r])}`):"u">typeof e[i]&&a.push(`${i}=${encodeURIComponent(e[i])}`)}),0===a.length?t:`${t}?${a.join("&")}`}({...t,asset:s})}(this.options)}toString(){return this.url()}}t=["The default export of @sanity/image-url has been deprecated. Use the named export `createImageUrlBuilder` instead."],e.s(["createImageUrlBuilder",0,function(e){return new u(null,c(e))}])},718917,e=>{e.v(t=>Promise.all(["static/chunks/3pgt5eg5ybvup.js"].map(t=>e.l(t))).then(()=>t(811067)))},839338,e=>{"use strict";var t=e.i(234915),r=e.i(240126);e.s(["firstValueFrom",0,function(e,i){var n="object"==typeof i;return new Promise(function(o,a){var s=new r.SafeSubscriber({next:function(e){o(e),s.unsubscribe()},error:a,complete:function(){n?o(i.defaultValue):a(new t.EmptyError)}});e.subscribe(s)})}])},305753,e=>{"use strict";var t=e.i(234915);e.s(["lastValueFrom",0,function(e,r){var i="object"==typeof r;return new Promise(function(n,o){var a,s=!1;e.subscribe({next:function(e){a=e,s=!0},error:o,complete:function(){s?n(a):i?n(r.defaultValue):o(new t.EmptyError)}})})}])},630330,502448,718244,e=>{"use strict";var t=e.i(394426),r=Array.isArray,i=Object.getPrototypeOf,n=Object.prototype,o=Object.keys;function a(e){if(1===e.length){var t,a=e[0];if(r(a))return{args:a,keys:null};if((t=a)&&"object"==typeof t&&i(t)===n){var s=o(a);return{args:s.map(function(e){return a[e]}),keys:s}}}return{args:e,keys:null}}e.s(["argsArgArrayOrObject",0,a],502448);var s=e.i(330823),l=e.i(979165),c=e.i(272383),u=e.i(673649);function d(e,t){return e.reduce(function(e,r,i){return e[r]=t[i],e},{})}e.s(["createObject",0,d],718244);var f=e.i(627608),p=e.i(175436);function h(e,t,r){return void 0===r&&(r=l.identity),function(i){g(t,function(){for(var n=e.length,o=Array(n),a=n,l=n,c=function(n){g(t,function(){var c=(0,s.from)(e[n],t),u=!1;c.subscribe((0,f.createOperatorSubscriber)(i,function(e){o[n]=e,!u&&(u=!0,l--),l||i.next(r(o.slice()))},function(){--a||i.complete()}))},i)},u=0;u<n;u++)c(u)},i)}}function g(e,t,r){e?(0,p.executeSchedule)(r,e,t):t()}e.s(["combineLatest",0,function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var i=(0,u.popScheduler)(e),n=(0,u.popResultSelector)(e),o=a(e),f=o.args,p=o.keys;if(0===f.length)return(0,s.from)([],i);var g=new t.Observable(h(f,i,p?function(e){return d(p,e)}:l.identity));return n?g.pipe((0,c.mapOneOrManyArgs)(n)):g},"combineLatestInit",0,h],630330)},602400,761101,e=>{"use strict";var t=e.i(844032);function r(){return(0,t.mergeAll)(1)}e.s(["concatAll",0,r],761101);var i=e.i(673649),n=e.i(330823);e.s(["concat",0,function(){for(var e=[],t=0;t<arguments.length;t++)e[t]=arguments[t];return r()((0,n.from)(e,(0,i.popScheduler)(e)))}],602400)},245281,e=>{"use strict";var t=e.i(673649),r=e.i(330823);e.s(["of",0,function(){for(var e=[],i=0;i<arguments.length;i++)e[i]=arguments[i];var n=(0,t.popScheduler)(e);return(0,r.from)(e,n)}])},254201,e=>{"use strict";var t=e.i(394426),r=e.i(603752);e.s(["throwError",0,function(e,i){var n=(0,r.isFunction)(e)?e:function(){return e},o=function(e){return e.error(n())};return new t.Observable(i?function(e){return i.schedule(o,0,e)}:o)}])},817312,161538,e=>{"use strict";var t=e.i(394426),r=e.i(629437),i=e.i(871041);function n(e){return e instanceof Date&&!isNaN(e)}e.s(["isValidDate",0,n],161538),e.s(["timer",0,function(e,o,a){void 0===e&&(e=0),void 0===a&&(a=r.async);var s=-1;return null!=o&&((0,i.isScheduler)(o)?a=o:s=o),new t.Observable(function(t){var r=n(e)?e-a.now():e;r<0&&(r=0);var i=0;return a.schedule(function(){t.closed||(t.next(i++),0<=s?this.schedule(void 0,s):t.complete())},r)})}],817312)},992481,e=>{"use strict";var t=e.i(220324),r=e.i(627608),i=e.i(902965);e.s(["catchError",0,function e(n){return(0,i.operate)(function(i,o){var a,s=null,l=!1;s=i.subscribe((0,r.createOperatorSubscriber)(o,void 0,void 0,function(r){a=(0,t.innerFrom)(n(r,e(n)(i))),s?(s.unsubscribe(),s=null,a.subscribe(o)):l=!0})),l&&(s.unsubscribe(),s=null,a.subscribe(o))})}])},589293,e=>{"use strict";var t=e.i(484973),r=e.i(603752);e.s(["concatMap",0,function(e,i){return(0,r.isFunction)(i)?(0,t.mergeMap)(e,i,1):(0,t.mergeMap)(e,1)}])},128068,e=>{"use strict";var t=e.i(902965);e.s(["finalize",0,function(e){return(0,t.operate)(function(t,r){try{t.subscribe(r)}finally{r.add(e)}})}])},373983,e=>{"use strict";var t=e.i(314052),r=e.i(902965);e.s(["reduce",0,function(e,i){return(0,r.operate)((0,t.scanInternals)(e,i,arguments.length>=2,!1,!0))}])},314052,e=>{"use strict";var t=e.i(627608);e.s(["scanInternals",0,function(e,r,i,n,o){return function(a,s){var l=i,c=r,u=0;a.subscribe((0,t.createOperatorSubscriber)(s,function(t){var r=u++;c=l?e(c,t,r):(l=!0,t),n&&s.next(c)},o&&function(){l&&s.next(c),s.complete()}))}}])},218692,e=>{"use strict";var t=e.i(603752),r=e.i(902965),i=e.i(627608),n=e.i(979165);e.s(["tap",0,function(e,o,a){var s=(0,t.isFunction)(e)||o||a?{next:e,error:o,complete:a}:e;return s?(0,r.operate)(function(e,t){null==(r=s.subscribe)||r.call(s);var r,n=!0;e.subscribe((0,i.createOperatorSubscriber)(t,function(e){var r;null==(r=s.next)||r.call(s,e),t.next(e)},function(){var e;n=!1,null==(e=s.complete)||e.call(s),t.complete()},function(e){var r;n=!1,null==(r=s.error)||r.call(s,e),t.error(e)},function(){var e,t;n&&(null==(e=s.unsubscribe)||e.call(s)),null==(t=s.finalize)||t.call(s)}))}):n.identity}])},629437,e=>{"use strict";var t=e.i(329418),r=new(e.i(796989)).AsyncScheduler(t.AsyncAction);e.s(["async",0,r,"asyncScheduler",0,r])},234915,e=>{"use strict";var t=(0,e.i(842093).createErrorClass)(function(e){return function(){e(this),this.name="EmptyError",this.message="no elements in sequence"}});e.s(["EmptyError",0,t])},545146,e=>{"use strict";var t=Array.isArray;e.s(["argsOrArgArray",0,function(e){return 1===e.length&&t(e[0])?e[0]:e}])},245912,e=>{"use strict";var t=e.i(394426),r=e.i(603752);e.s(["isObservable",0,function(e){return!!e&&(e instanceof t.Observable||(0,r.isFunction)(e.lift)&&(0,r.isFunction)(e.subscribe))}])},948025,e=>{"use strict";var t=e.i(481293);let r={texture:{width:1920,height:1920,quality:85},trail:{width:640,height:800,quality:85},pattern:{width:1480,height:1480,quality:85}};e.s(["imageRenditionSrc",0,(e,i)=>{let n=(0,t.resolveSanityImage)(e);if(!n)return null;try{let{width:e,height:o,quality:a}=r[i],s=(0,t.imageDimensions)(n),l=s?Math.max(1,Math.min(e,Math.floor(o*s.width/s.height))):e,c=(0,t.urlFor)(n).width(l).fit("max").quality(a);return"texture"===i?c.format("webp").url():c.auto("format").url()}catch{return null}}])},794635,e=>{"use strict";var t=e.i(843476),r=e.i(500932),i=e.i(156569),n=e.i(124821),o=e.i(375476),a=e.i(481293),s=e.i(992325),l=e.i(494473),c=e.i(867308),u=e.i(989970),d=e.i(255667),f=e.i(328852),p=e.i(271645),h=e.i(607561),g=e.i(575509),m=e.i(212960),v=e.i(997053);let b=(0,v.default)(g.Div).attrs({as:"section"}).withConfig({componentId:"sc-e85696e3-0"})(()=>v.css`
	...
	`),E=(0,v.default)(g.Div).withConfig({componentId:"sc-e85696e3-4"})(()=>v.css`
	
	`),$=(0,v.default)(g.Div).withConfig({componentId:"sc-e85696e3-5"})(({theme:e})=>v.css`
    ...
    `),T=(0,v.default)(g.Div).attrs({as:"p"}).withConfig({componentId:"sc-e85696e3-6"})(()=>v.css`
		...
		text-wrap: balance;
	`),S=e=>{let i,n,o,a=(0,r.c)(7),{image:s}=e,l=(0,p.useRef)(null),g=(0,p.useRef)(null),m=(0,d.useLenis)();a[0]!==m?.rootElement?(i=e=>{let{isDesktop:t}=e,r=l.current,i=g.current,n=m?.rootElement;if(!r||!i||!n)return;let o=()=>t?0:n.clientHeight,a=()=>(e=>{let t=0,r=e;for(;r;)t+=r.offsetTop,r=r.offsetParent;return t})(r)+(t?c.APPROACH_HOLD_PX:0)-o(),s=u.default.fromTo(i,{yPercent:0},{yPercent:t?25:24,ease:"none",scrollTrigger:{scroller:n,start:a,end:()=>a()+o()+r.offsetHeight,scrub:!0,invalidateOnRefresh:!0}});return()=>{s.scrollTrigger?.kill(),s.kill()}},a[0]=m?.rootElement,a[1]=i):i=a[1];let v=s?.src;return(a[2]!==m||a[3]!==v?(n={scope:l,dependencies:[v,m]},a[2]=m,a[3]=v,a[4]=n):n=a[4],(0,h.useAnimation)(i,n),s?.src)?(a[5]!==s?(o=(0,t.jsx)(y,{ref:l,children:(0,t.jsx)(w,{ref:g,children:(0,t.jsx)(f.default,{image:s,fill:!0,sizes:"100vw",preload:!0})})}),a[5]=s,a[6]=o):o=a[6],o):null};S.displayName="Background";let A=e=>{let c,u,d,f,p,h,g,m,v,y,w,A=(0,r.c)(26),{heading:I,description:_,backgroundImage:R,logos:j,documentId:k,documentType:C}=e;A[0]!==R?(c=(0,a.resolveImageWithAlt)(R),A[0]=R,A[1]=c):c=A[1];let L=c;A[2]!==k||A[3]!==C?(u=(0,s.sanityEditAttr)({id:k,type:C,path:"approachHeading"}),A[2]=k,A[3]=C,A[4]=u):u=A[4];let P=u;return A[5]!==L?(d=(0,t.jsx)(S,{image:L}),A[5]=L,A[6]=d):d=A[6],A[7]!==I?(f=(0,t.jsx)("h2",{children:I}),A[7]=I,A[8]=f):f=A[8],A[9]!==P||A[10]!==f?(p=(0,t.jsx)(l.default,{"data-level":"top",children:(0,t.jsx)(x,{$l:"2/7",children:(0,t.jsx)(i.default,{editAttr:P,children:f})})}),A[9]=P,A[10]=f,A[11]=p):p=A[11],A[12]!==j?(h=(0,t.jsx)(E,{$l:"1/8",$xl:"1/9",children:(0,t.jsx)(o.default,{logos:j})}),A[12]=j,A[13]=h):h=A[13],A[14]!==_?(g=(0,t.jsx)(T,{children:_}),A[14]=_,A[15]=g):g=A[15],A[16]===Symbol.for("react.memo_cache_sentinel")?(m=(0,t.jsx)(n.default,{to:"/contact",label:"Start Your Project",aria:"Go to Contact"}),A[16]=m):m=A[16],A[17]!==g?(v=(0,t.jsxs)($,{$l:"8/12",$xl:"9/12",children:[g,m]}),A[17]=g,A[18]=v):v=A[18],A[19]!==h||A[20]!==v?(y=(0,t.jsxs)(l.default,{"data-level":"bottom",$noMargin:!0,$noGutter:!0,children:[h,v]}),A[19]=h,A[20]=v,A[21]=y):y=A[21],A[22]!==y||A[23]!==d||A[24]!==p?(w=(0,t.jsxs)(b,{children:[d,p,y]}),A[22]=y,A[23]=d,A[24]=p,A[25]=w):w=A[25],w};A.displayName="Approach",e.s(["default",0,A],794635)},419762,e=>{"use strict";var t=e.i(843476),r=e.i(500932),i=e.i(156569),n=e.i(481293),o=e.i(948025),a=e.i(189897),s=e.i(607561),l=e.i(494473),c=e.i(989970),u=e.i(255667),d=e.i(328852),f=e.i(271645),p=e.i(575509),h=e.i(212960),g=e.i(997053);let m=(0,g.default)(p.Div).attrs({as:"section"}).withConfig({componentId:"sc-dd0c2790-0"})(()=>g.css`
    ...
    `),y=(0,g.default)(p.Div).attrs({as:"div"}).withConfig({componentId:"sc-dd0c2790-3"})(({theme:e})=>g.css`
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `),w=(0,g.default)(p.Div).withConfig({componentId:"sc-dd0c2790-4"})(()=>g.css`
        position: relative;
    ...
    `);e.s(["Background",0,v,"BackgroundParallax",0,b,"Cars",0,w,"Content",0,y,"Jacket",0,m],448578);let x=(0,f.forwardRef)((e,i)=>{let n,o,a,s,l,c,u,d,p=(0,r.c)(22),{src:h,tileSize:g,opacity:m}=e,y=void 0===g?740:g,w=void 0===m?1:m,x=(0,f.useRef)(null),E=(0,f.useId)();if(p[0]!==E){let e;p[2]===Symbol.for("react.memo_cache_sentinel")?(e=/:/g,p[2]=e):e=p[2],n=E.replace(e,""),p[0]=E,p[1]=n}else n=p[1];let $=`builds-intro-pattern-${n}`;p[3]!==i?(o=e=>{(x.current=e,"function"==typeof i)?i(e):i&&(i.current=e)},p[3]=i,p[4]=o):o=p[4];let T=o;if(!h)return null;p[5]===Symbol.for("react.memo_cache_sentinel")?(a=(0,t.jsx)("figure",{}),p[5]=a):a=p[5],p[6]!==h||p[7]!==y?(s=(0,t.jsx)("image",{href:h,width:y,height:y,preserveAspectRatio:"xMidYMid slice"}),p[6]=h,p[7]=y,p[8]=s):s=p[8],p[9]!==$||p[10]!==s||p[11]!==y?(l=(0,t.jsx)("defs",{children:(0,t.jsx)("pattern",{id:$,patternUnits:"userSpaceOnUse",width:y,height:y,children:s})}),p[9]=$,p[10]=s,p[11]=y,p[12]=l):l=p[12];let S=`url(#${$})`;return p[13]!==w||p[14]!==S?(c=(0,t.jsx)("rect",{width:"100%",height:"100%",fill:S,opacity:w}),p[13]=w,p[14]=S,p[15]=c):c=p[15],p[16]!==c||p[17]!==l?(u=(0,t.jsxs)("svg",{width:"100%",height:"100%",preserveAspectRatio:"none","aria-hidden":!0,role:"presentation",children:[l,c]}),p[16]=c,p[17]=l,p[18]=u):u=p[18],p[19]!==T||p[20]!==u?(d=(0,t.jsxs)(v,{"aria-hidden":!0,children:[a,(0,t.jsx)(b,{ref:T,children:u})]}),p[19]=T,p[20]=u,p[21]=d):d=p[21],d});x.displayName="BuildsIntroductionBackground";var E=e.i(448578);let $=e=>{let p,h,g,m,v,b,y,w,$,T,S,A,I,_,R,j,k,C,L=(0,r.c)(45),{line1:P,line2:O,description:D,backgroundImage:M,image:N,leftCarImage:H,rightCarImage:z}=e,U=(0,n.resolveImageWithAlt)(M);L[0]!==N?(p=(0,n.resolveImageWithAlt)(N),L[0]=N,L[1]=p):p=L[1];let G=p;L[2]!==H?(h=(0,n.resolveImageWithAlt)(H),L[2]=H,L[3]=h):h=L[3];let F=h;L[4]!==z?(g=(0,n.resolveImageWithAlt)(z),L[4]=z,L[5]=g):g=L[5];let B=g,W=(0,f.useRef)(null),V=(0,f.useRef)(null),X=(0,f.useRef)(null),q=(0,f.useRef)(null),Y=(0,f.useRef)(null),J=(0,f.useRef)(null),K=(0,f.useRef)(null),Z=(0,f.useRef)(null),Q=(0,u.useLenis)();L[6]!==P?(m=(0,a.cleanSanityString)(P),L[6]=P,L[7]=m):m=L[7];let ee=m;L[8]!==O?(v=(0,a.cleanSanityString)(O),L[8]=O,L[9]=v):v=L[9];let et=v;L[10]!==D?(b=(0,a.cleanSanityString)(D),L[10]=D,L[11]=b):b=L[11];let er=b;if(L[12]!==Q?.rootElement?(y=e=>{let{isDesktop:t}=e,r=W.current,i=Q?.rootElement,n=X.current,o=q.current,a=Y.current,s=J.current,l=V.current,u=K.current,d=Z.current;r&&i&&n&&o&&a&&s&&l&&u&&d&&(c.default.to(n,{scale:.75,autoAlpha:0,ease:"none",scrollTrigger:{trigger:r,scroller:i,start:"top top",end:"center top",scrub:!0,markers:!1}}),t&&c.default.from(u,{y:"-50dvh",scale:.75,ease:"none",scrollTrigger:{trigger:d,scroller:i,start:"top-=50% 100%",end:"center 60%",scrub:.2,markers:!1}}),c.default.to(o,{yPercent:-55,ease:"none",scrollTrigger:{trigger:s,scroller:i,start:"top bottom",end:"center top",scrub:.2}}),c.default.to(a,{yPercent:-50,ease:"none",scrollTrigger:{trigger:s,scroller:i,start:"top bottom",end:"bottom top",scrub:.2}}),c.default.set(l,{yPercent:-10}),c.default.to(l,{yPercent:20,ease:"none",scrollTrigger:{trigger:r,scroller:i,start:"top bottom",end:"bottom top",scrub:!0,markers:!1}}))},L[12]=Q?.rootElement,L[13]=y):y=L[13],L[14]!==Q?(w={scope:W,dependencies:[Q]},L[14]=Q,L[15]=w):w=L[15],(0,s.useAnimation)(y,w),!G||!F||!B||!ee||!et||!er||!U)return null;let ei=(0,o.imageRenditionSrc)(U.image,"pattern")??void 0;return L[16]!==x||L[17]!==U.alt||L[18]!==ei?($=(0,t.jsx)(x,{ref:V,src:ei,alt:U.alt}),L[16]=x,L[17]=U.alt,L[18]=ei,L[19]=$):$=L[19],L[20]!==ee?(T=(0,t.jsx)(l.default,{"data-placement":"top",ref:X,children:(0,t.jsx)(E.Content,{$l:"5/9",children:(0,t.jsx)(i.default,{children:(0,t.jsx)("em",{children:ee})})})}),L[20]=ee,L[21]=T):T=L[21],L[22]!==F?(S=(0,t.jsx)("picture",{"data-car":"side","data-side":"left",ref:q,children:(0,t.jsx)(d.default,{image:F,fill:!0,sizes:"(min-width: 1024px) 35vw, 50vw"})}),L[22]=F,L[23]=S):S=L[23],L[24]!==G?(A=(0,t.jsx)("picture",{"data-car":"main",children:(0,t.jsx)(d.default,{image:G,fill:!0,sizes:"(min-width: 1024px) 70.7rem, 100vw"})}),L[24]=G,L[25]=A):A=L[25],L[26]!==B?(I=(0,t.jsx)("picture",{"data-car":"side","data-side":"right",ref:Y,children:(0,t.jsx)(d.default,{image:B,fill:!0,sizes:"(min-width: 1024px) 35vw, 50vw"})}),L[26]=B,L[27]=I):I=L[27],L[28]!==S||L[29]!==A||L[30]!==I?(_=(0,t.jsxs)(E.Cars,{ref:J,children:[S,A,I]}),L[28]=S,L[29]=A,L[30]=I,L[31]=_):_=L[31],L[32]!==et?(R=(0,t.jsx)(i.default,{children:(0,t.jsx)("h2",{children:et})}),L[32]=et,L[33]=R):R=L[33],L[34]!==er?(j=(0,t.jsx)("p",{children:er}),L[34]=er,L[35]=j):j=L[35],L[36]!==R||L[37]!==j?(k=(0,t.jsx)(l.default,{"data-placement":"bottom",ref:Z,children:(0,t.jsxs)(E.Content,{$l:"4/10",$huge:"3/11",ref:K,children:[R,j]})}),L[36]=R,L[37]=j,L[38]=k):k=L[38],L[39]!==$||L[40]!==T||L[41]!==_||L[42]!==k||L[43]!==E.Jacket?(C=(0,t.jsxs)(E.Jacket,{ref:W,children:[$,T,_,k]}),L[39]=$,L[40]=T,L[41]=_,L[42]=k,L[43]=E.Jacket,L[44]=C):C=L[44],C};$.displayName="BuildsIntroduction",e.s(["default",0,$],419762)},103930,e=>{"use strict";var t=e.i(843476),r=e.i(500932),i=e.i(156569),n=e.i(124821),o=e.i(89835),a=e.i(481293),s=e.i(607561),l=e.i(494473),c=e.i(989970),u=e.i(255667),d=e.i(271645),f=e.i(575509),p=e.i(212960),h=e.i(997053);let g=(0,h.default)(f.Div).attrs({as:"section"}).withConfig({componentId:"sc-8d5ca2ab-0"})(({$hasFade:e})=>h.css`
        position: relative;
        z-index: 1;
        overflow: clip;
        height: 100dvh;
    ...
    `),v=(0,h.default)(f.Div).attrs({as:"div"}).withConfig({componentId:"sc-8d5ca2ab-2"})(()=>h.css`
        position: relative;
        z-index: 1;
	...
	`),E=(0,v.default)(g.Div).attrs({as:"p"}).withConfig({componentId:"sc-12ea9db1-4"})(()=>v.css`
	${m.bodyL}
	...
	visibility: hidden;
	opacity: 0;
`),$="sine.inOut",T=()=>{let e,o,a,g,m,v,b,x,E,T,A,I,_,R=(0,r.c)(38),{loaderMounted:j}=(0,s.use)(c.LoaderContext),{menuOpen:k}=(0,s.use)(u.MenuContext),{isReducedMotion:C,devicePixelRatio:L}=(0,s.use)(d.PerformanceContext),{activeFrameRef:P,heroVideoLoadState:O,isRuntimeReady:D,setHeroPlaybackComplete:M,isHeroPlaybackComplete:N,isIntroFrameReady:H,setHeroFrameSettled:z}=(0,s.use)(l.HeroVideoContext),{getProgress:U,subscribe:G,getIntroSegmentProgress:F}=(0,i.useStickyTrackStore)(),B=(0,s.useRef)(k),W=(0,s.useRef)(null),V=(0,s.useRef)(null),X=(0,s.useRef)(null),q=(0,s.useRef)(null),Y=(0,s.useRef)(null),J=(0,s.useRef)(0),K=(0,s.useRef)(0),Z=(0,s.useRef)(!1),Q=(0,s.useRef)(!0),[ee,et]=(0,s.useState)(!1),[er,ei]=(0,s.useState)(!1),en=(0,s.useRef)(!1),eo="ready"===O;R[0]!==L?(e=()=>{let e=V.current,t=W.current;if(!e||!t)return!1;let r=Math.min(L,2),{clientWidth:i,clientHeight:n}=t;if(!i||!n)return!1;e.width=Math.round(i*r),e.height=Math.round(n*r),e.style.width=`${i}px`,e.style.height=`${n}px`;let o=e.getContext("2d");return!!o&&(X.current=o,o.setTransform(r,0,0,r,0,0),!0)},R[0]=L,R[1]=e):e=R[1];let ea=e;R[2]!==P||R[3]!==ea?(o=()=>{cancelAnimationFrame(K.current),K.current=requestAnimationFrame(()=>{if(!ea())return;let e=P.current;e&&(0,f.forceRedrawFrame)(e,J.current)})},R[2]=P,R[3]=ea,R[4]=o):o=R[4];let es=o;return(R[5]!==U||R[6]!==k?(a=()=>{B.current=k,k?q.current?.pause():(0,n.shouldPauseHeroPlayback)(U())||q.current?.play()},g=[k,U],R[5]=U,R[6]=k,R[7]=a,R[8]=g):(a=R[7],g=R[8]),(0,s.useLayoutEffect)(a,g),R[9]===Symbol.for("react.memo_cache_sentinel")?(m=()=>{et((0,p.canUseWebCodecs)())},v=[],R[9]=m,R[10]=v):(m=R[9],v=R[10]),(0,s.useEffect)(m,v),R[11]!==P||R[12]!==es||R[13]!==ee||R[14]!==D||R[15]!==eo||R[16]!==ea?(b=()=>{if(!D||!ee||!eo)return;let e=V.current,t=P.current;if(!e||!t)return;let r=null;return ea()&&(t.process=e=>{let t=X.current,r=W.current;t&&r&&(0,f.drawCoverFrame)(t,e,r.clientWidth,r.clientHeight)},J.current=0,(0,f.forceRedrawFrame)(t,0),ei(!0),r=new ResizeObserver(es),W.current&&r.observe(W.current),window.addEventListener("resize",es)),()=>{cancelAnimationFrame(K.current),window.removeEventListener("resize",es),ei(!1),X.current=null,r?.disconnect(),t.process=S}},x=[P,es,ee,D,eo,ea],R[11]=P,R[12]=es,R[13]=ee,R[14]=D,R[15]=eo,R[16]=ea,R[17]=b,R[18]=x):(b=R[17],x=R[18]),(0,s.useLayoutEffect)(b,x),R[19]!==P||R[20]!==U||R[21]!==j||R[22]!==er||R[23]!==C||R[24]!==M||R[25]!==G?(E=()=>{if(j||C||!er)return;let e=P.current;if(!e?.manifest)return void M(!0);let{totalFrames:t}=e.manifest;if(t<=1)return void M(!0);let r={frame:0},i=t-1;en.current=!1,Z.current=!1,M(!1),J.current=0,(0,f.forceRedrawFrame)(e,0),Q.current=!0,Y.current?.kill(),Y.current=null;let o=W.current;o&&(o.style.visibility="visible",h.default.set(o,{opacity:1}));let a=()=>{en.current||(en.current=!0,Z.current=!0,J.current=i,e.setFrame(i),M(!0),q.current?.kill(),q.current=null)};q.current=h.default.to(r,{frame:i,paused:B.current,duration:2,ease:"none",onUpdate:()=>{if(B.current||(0,n.shouldPauseHeroPlayback)(U()))return void q.current?.pause();let t=Math.round(r.frame);J.current=t;try{e.setFrame(t)}catch{a();return}t>=i&&a()},onComplete:a});let s=()=>{if(q.current&&!en.current){if(B.current||(0,n.shouldPauseHeroPlayback)(U()))return void q.current.pause();q.current.play()}};s();let l=G(s);return()=>{l(),q.current?.kill(),q.current=null}},T=[P,U,j,er,C,M,G],R[19]=P,R[20]=U,R[21]=j,R[22]=er,R[23]=C,R[24]=M,R[25]=G,R[26]=E,R[27]=T):(E=R[26],T=R[27]),(0,s.useEffect)(E,T),R[28]!==F||R[29]!==U||R[30]!==N||R[31]!==H||R[32]!==C||R[33]!==z||R[34]!==G?(A=()=>{let e=()=>{let e=F(U())>0,t=N||Z.current,r=!H||!t&&!e,i=W.current;if(!i||Q.current===r)return;Q.current=r,Y.current?.kill();let n=.3*!C;if(r){z(!1),i.style.visibility="visible",Y.current=h.default.to(i,{opacity:1,duration:n,ease:$,overwrite:!0});return}Y.current=h.default.to(i,{opacity:0,duration:n,ease:$,overwrite:!0,onComplete:()=>{Q.current||(i.style.visibility="hidden",z(!0))}})};e();let t=G(e);return()=>{t(),Y.current?.kill(),Y.current=null,z(!1)}},I=[F,U,N,H,C,G,z],R[28]=F,R[29]=U,R[30]=N,R[31]=H,R[32]=C,R[33]=z,R[34]=G,R[35]=A,R[36]=I):(A=R[35],I=R[36]),(0,s.useEffect)(A,I),ee&&D&&"unsupported"!==O&&"error"!==O)?(R[37]===Symbol.for("react.memo_cache_sentinel")?(_=(0,t.jsx)(y,{ref:W,"aria-hidden":"true",children:(0,t.jsx)(w,{ref:V})}),R[37]=_):_=R[37],_):null};function S(){}T.displayName="Background";var A=e.i(486861),I=e.i(189897),_=e.i(607561),R=e.i(797489),j=e.i(274879),k=e.i(448806),C=e.i(875324),L=e.i(221781);let P=e=>{h.default.set(e,{autoAlpha:1,yPercent:0,willChange:"auto"})},O=e=>{let n,o,a,l,f,p,g,m,v,b,y=(0,r.c)(36),{description:w,editAttr:x}=e,{loaderMounted:$}=(0,s.use)(c.LoaderContext),{menuVisible:T}=(0,s.use)(u.MenuContext),{isReducedMotion:S}=(0,s.use)(d.PerformanceContext),{getProgress:O,subscribe:D,getHeroTextSegmentProgress:M}=(0,i.useStickyTrackStore)(),N=(0,k.usePageTransitioning)(),H=(0,s.useRef)(null);y[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],y[0]=n):n=y[0];let z=(0,s.useRef)(n),U=(0,s.useRef)(!1),G=(0,s.useRef)(-1),[F,B]=(0,s.useState)(!1);y[1]!==w?(o=(0,I.cleanSanityString)(w),y[1]=w,y[2]=o):o=y[2];let W=o,V=!F&&($||N||T),X=(0,j.useSplitTextRecovery)(H,W);y[3]!==W?(a=(0,A.escapeHtml)(W),y[3]=W,y[4]=a):a=y[4];let q=(0,R.useInnerHtml)(a);return(y[5]!==W||y[6]!==V||y[7]!==S?(l=()=>{if(!H.current||!W)return;let e=C.SplitText.create(H.current,{type:"lines",linesClass:"line",mask:"lines",aria:"none"}),{lines:t}=e;return(z.current=t,G.current=-1,t.length)?(h.default.set(H.current,{autoAlpha:1}),S||U.current)?(P(t),B(!0),()=>e.revert()):(h.default.set(t,{autoAlpha:0,yPercent:100,willChange:"opacity, transform"}),V)?()=>e.revert():(h.default.timeline({delay:1,onComplete:()=>{U.current=!0,B(!0),h.default.set(t,{willChange:"auto"})}}).to(t,{autoAlpha:1,yPercent:0,duration:L.DESCRIPTION_LINE_REVEAL,stagger:L.DESCRIPTION_LINE_GAP,ease:"power3.out"}),()=>e.revert()):()=>e.revert()},y[5]=W,y[6]=V,y[7]=S,y[8]=l):l=y[8],y[9]!==W||y[10]!==V||y[11]!==S||y[12]!==X?(f={scope:H,dependencies:[W,V,S,X]},y[9]=W,y[10]=V,y[11]=S,y[12]=X,y[13]=f):f=y[13],(0,_.useAnimation)(l,f),y[14]!==M||y[15]!==O||y[16]!==F||y[17]!==S||y[18]!==D?(p=()=>{if(!F||S)return;let e=()=>{let e=z.current;if(!e.length)return;let t=.002*Math.round(M(O())/.002);if(t!==G.current){if(G.current=t,t<=0)return void P(e);for(let[r,i]of e.entries()){let n=(0,L.getStaggeredSegmentProgress)(t,r,e.length,L.DESCRIPTION_LINE_GAP,L.DESCRIPTION_LINE_REVEAL);h.default.set(i,{autoAlpha:1-n,yPercent:100*n,willChange:"opacity, transform"})}}};return e(),D(e)},y[14]=M,y[15]=O,y[16]=F,y[17]=S,y[18]=D,y[19]=p):p=y[19],y[20]!==M||y[21]!==O||y[22]!==F||y[23]!==S||y[24]!==X||y[25]!==D?(g=[M,O,F,S,D,X],y[20]=M,y[21]=O,y[22]=F,y[23]=S,y[24]=X,y[25]=D,y[26]=g):g=y[26],(0,s.useEffect)(p,g),W)?(y[27]!==W?(m=(0,t.jsx)("span",{className:"sr-only",children:W}),y[27]=W,y[28]=m):m=y[28],y[29]!==q||y[30]!==W||y[31]!==x?(v=(0,t.jsx)(E,{ref:H,"aria-hidden":!0,$l:"4/10",$xl:"5/9","data-sanity":x,dangerouslySetInnerHTML:q},W),y[29]=q,y[30]=W,y[31]=x,y[32]=v):v=y[32],y[33]!==m||y[34]!==v?(b=(0,t.jsxs)(t.Fragment,{children:[m,v]}),y[33]=m,y[34]=v,y[35]=b):b=y[35],b):null};O.displayName="HeroDescription";let D=(e,t)=>{let r=e.getBoundingClientRect(),i=r.left+r.width/2,n=r.top+r.height/2;for(let e of t){let t=e.getBoundingClientRect();h.default.set(e,{transformOrigin:`${i-t.left}px ${n-t.top}px`})}},M=e=>{h.default.set(e,{autoAlpha:1,scale:1,display:"inline-block",verticalAlign:"top",filter:"blur(0px)",willChange:"auto"})},N=e=>{let n,o,a,l,f,p,g,m,v,b,y=(0,r.c)(34),{title:w,editAttr:E}=e,{loaderMounted:$}=(0,s.use)(c.LoaderContext),{menuVisible:T}=(0,s.use)(u.MenuContext),{isReducedMotion:S}=(0,s.use)(d.PerformanceContext),{getProgress:P,subscribe:O,getHeroTextSegmentProgress:N}=(0,i.useStickyTrackStore)(),H=(0,k.usePageTransitioning)(),z=(0,s.useRef)(null);y[0]===Symbol.for("react.memo_cache_sentinel")?(n=[],y[0]=n):n=y[0];let U=(0,s.useRef)(n),G=(0,s.useRef)(!1),F=(0,s.useRef)(-1),[B,W]=(0,s.useState)(!1);y[1]!==w?(o=(0,I.cleanSanityString)(w),y[1]=w,y[2]=o):o=y[2];let V=o,X=!B&&($||H||T),q=(0,j.useSplitTextRecovery)(z,V);y[3]!==V?(a=(0,A.escapeHtml)(V),y[3]=V,y[4]=a):a=y[4];let Y=(0,R.useInnerHtml)(a);return(y[5]!==V||y[6]!==X||y[7]!==S?(l=()=>{if(!z.current||!V)return;let e=C.SplitText.create(z.current,{type:"words"}),{words:t}=e;return(U.current=t,F.current=-1,t.length)?(h.default.set(z.current,{autoAlpha:1}),S||G.current)?(M(t),W(!0),()=>e.revert()):(D(z.current,t),h.default.set(t,{autoAlpha:0,scale:L.TITLE_SCALE_START,display:"inline-block",verticalAlign:"top",filter:`blur(${L.TITLE_BLUR_START}px)`,willChange:"opacity, transform, filter"}),X)?()=>e.revert():(h.default.timeline({delay:.75,onComplete:()=>{G.current=!0,W(!0),h.default.set(t,{willChange:"auto"})}}).to(t,{autoAlpha:1,scale:1,filter:"blur(0px)",duration:L.TITLE_WORD_REVEAL,stagger:L.TITLE_WORD_GAP,ease:"power2.out"}),()=>e.revert()):()=>e.revert()},y[5]=V,y[6]=X,y[7]=S,y[8]=l):l=y[8],y[9]!==V||y[10]!==X||y[11]!==S||y[12]!==q?(f={scope:z,dependencies:[V,X,S,q]},y[9]=V,y[10]=X,y[11]=S,y[12]=q,y[13]=f):f=y[13],(0,_.useAnimation)(l,f),y[14]!==B?(p=()=>{B&&z.current&&U.current.length&&D(z.current,U.current)},g=[B],y[14]=B,y[15]=p,y[16]=g):(p=y[15],g=y[16]),(0,s.useEffect)(p,g),y[17]!==N||y[18]!==P||y[19]!==B||y[20]!==S||y[21]!==O?(m=()=>{if(!B||S)return;let e=()=>{let e=U.current;if(!e.length)return;let t=.002*Math.round(N(P())/.002);if(t!==F.current){if(F.current=t,t<=0)return void M(e);for(let[r,i]of e.entries()){let{scale:n,opacity:o,blur:a}=(0,L.getGrowOutWordValues)(t,r,e.length);h.default.set(i,{autoAlpha:o,scale:n,filter:`blur(${a}px)`})}}};return e(),O(e)},y[17]=N,y[18]=P,y[19]=B,y[20]=S,y[21]=O,y[22]=m):m=y[22],y[23]!==N||y[24]!==P||y[25]!==B||y[26]!==S||y[27]!==q||y[28]!==O?(v=[N,P,B,S,O,q],y[23]=N,y[24]=P,y[25]=B,y[26]=S,y[27]=q,y[28]=O,y[29]=v):v=y[29],(0,s.useEffect)(m,v),V)?(y[30]!==V||y[31]!==E||y[32]!==Y?(b=(0,t.jsx)(x,{ref:z,$s:"1/5",$m:"2/6",$l:"4/10","data-sanity":E,dangerouslySetInnerHTML:Y},V),y[30]=V,y[31]=E,y[32]=Y,y[33]=b):b=y[33],b):null};N.displayName="HeroTitle";let H=e=>{let l,c,u,d,f,p,h,g,m=(0,r.c)(20),{title:v,description:y,textScrollLength:w,documentId:x,documentType:E}=e,$=void 0===w?n.DEFAULT_HERO_TEXT_SCROLL_LENGTH:w,{setHeroTextScrollLength:S}=(0,i.useStickyTrackStore)();m[0]!==x||m[1]!==E?(l=(0,o.sanityEditAttr)({id:x,type:E,path:"heroHeading"}),m[0]=x,m[1]=E,m[2]=l):l=m[2];let A=l;m[3]!==x||m[4]!==E?(c=(0,o.sanityEditAttr)({id:x,type:E,path:"heroDescription"}),m[3]=x,m[4]=E,m[5]=c):c=m[5];let I=c;return m[6]!==S||m[7]!==$?(u=()=>(S($),()=>{S(n.DEFAULT_HERO_TEXT_SCROLL_LENGTH)}),d=[S,$],m[6]=S,m[7]=$,m[8]=u,m[9]=d):(u=m[8],d=m[9]),(0,s.useLayoutEffect)(u,d),m[10]===Symbol.for("react.memo_cache_sentinel")?(f=(0,t.jsx)(T,{}),m[10]=f):f=m[10],m[11]!==v||m[12]!==A?(p=(0,t.jsx)(a.default,{"data-text":"top",children:(0,t.jsx)(N,{title:v,editAttr:A})}),m[11]=v,m[12]=A,m[13]=p):p=m[13],m[14]!==y||m[15]!==I?(h=(0,t.jsx)(a.default,{"data-text":"bottom",children:(0,t.jsx)(O,{description:y,editAttr:I})}),m[14]=y,m[15]=I,m[16]=h):h=m[16],m[17]!==p||m[18]!==h?(g=(0,t.jsxs)(b,{"data-page-route":"/",children:[f,p,h]}),m[17]=p,m[18]=h,m[19]=g):g=m[19],g};H.displayName="Hero",e.s(["default",0,H],601969)},958643,e=>{"use strict";var t=e.i(843476),r=e.i(500932),i=e.i(322208),n=e.i(867308),o=e.i(992325),a=e.i(271645),s=e.i(383520),l=e.i(101384),c=e.i(456393),u=e.i(259553),d=e.i(478430),f=e.i(831119),p=e.i(607561),h=e.i(989970);let g=16/9,m=`
...
void main() {
  ...
  gl_FragColor = vec4(texture2D(colour, displaced).rgb, 1.0);
}`;var b=e.i(255981);let y=(e,t,r)=>e?t??"/videos/intro-scroll.af":r??"/videos/intro-scroll.af";var w=e.i(575509),x=e.i(212960),E=e.i(997053);let $=(0,E.default)(w.Div).attrs({as:"section"}).withConfig({componentId:"sc-2b039258-0"})(({$elevated:e=!1})=>E.css`
		position: absolute;
		z-index: ${e?3:1};
		inset: 0;
		width: 100%;
		...
		overflow: hidden;
		pointer-events: none;
	`),T=E.default.div.withConfig({componentId:"sc-2b039258-1"})(()=>E.css`
		position: absolute;
		inset: 0;
		pointer-events: none;
	`),S=E.default.canvas.withConfig({componentId:"sc-2b039258-2"})(()=>E.css`
		display: block;
		width: 100%;
		height: 100%;
	`),A=E.default.div.withConfig({componentId:"sc-2b039258-3"})(()=>E.css`
		position: absolute;
		z-index: 2;
		inset: 0;
		display: flex;
		...
		pointer-events: none;
	`),I=(0,E.default)(w.Div).attrs({as:"h2"}).withConfig({componentId:"sc-2b039258-4"})(()=>E.css`
		${x.headlineS}
		text-align: center;
		text-wrap: balance;
		visibility: hidden;
		...
		${w.bp.l`
			text-wrap: balance;
		`}
	`),_=E.default.div.withConfig({componentId:"sc-2b039258-5"})(()=>E.css`
		position: absolute;
		inset: 0;
	`),R=E.default.canvas.withConfig({componentId:"sc-2b039258-6"})(()=>E.css`
		position: absolute;
		inset: 0;
		width: 100%;
		height: 100%;
	...
	`),M=E.default.div.withConfig({componentId:"sc-d2fec375-1"})(()=>E.css`
		position: relative;
		width: 100%;
		height: 100%;
	`),N=E.default.div.withConfig({componentId:"sc-d2fec375-2"})(()=>E.css`
		position: absolute;
		width: 21.6rem;
		height: 27rem;
		overflow: hidden;
		...
		opacity: 0;
		visibility: hidden;
	`),H=E.default.img.withConfig({componentId:"sc-d2fec375-3"})(()=>E.css`
		width: 100%;
		height: 100%;
		object-fit: cover;
	`),z=e=>{let o,s,c,u,d,f,p,g,m=(0,r.c)(20),{images:v}=e;m[0]!==v?(o=void 0===v?[]:v,m[0]=v,m[1]=o):o=m[1];let b=o,{isReducedMotion:y}=(0,a.use)(l.PerformanceContext),{getProgress:w,subscribe:x,getIntroSegmentProgress:E}=(0,i.useStickyTrackStore)(),$=(0,a.useRef)(null),[T,S]=(0,a.useState)(!1);m[2]!==b?(s=b.map(U).filter(G),m[2]=b,m[3]=s):s=m[3];let A=s;m[4]!==A?(c=A.map(F).join("|"),m[4]=A,m[5]=c):c=m[5];let I=c;return(m[6]!==E||m[7]!==w||m[8]!==I||m[9]!==y||m[10]!==x?(u=()=>{let e=$.current;if(!e||!I||y)return;let t=((e,t={})=>{let r={...O,...t};if(window.innerWidth<r.minWidth)return null;let i=Array.from(e.querySelectorAll('[data-trail="item"]'));if(!i.length)return null;let n=Math.max(1,Math.min(r.trailLength,i.length-1)),o={trailInterval:null,globalIndex:0,last:{x:0,y:0},trailImageTimestamps:new Map,isActive:!1},a=new Map,s=e=>{h.default.to(e,{opacity:0,scale:.2,duration:.8,ease:"expo.out",onComplete:()=>{h.default.set(e,{autoAlpha:0})}})},l=t=>{let l,c,u;if(!o.isActive)return;let d=e.getBoundingClientRect(),{x:f,y:p}={x:t.clientX-d.left,y:t.clientY-d.top};if(l=f,c=p,u=o.last.x,Math.hypot(u-l,o.last.y-c)>window.innerWidth/r.moveDistance){var g;let e,t;if(g=i[o.globalIndex%i.length],e=a.get(g)??{width:g.offsetWidth,height:g.offsetHeight},a.has(g)||a.set(g,e),t={left:`${f-e.width/2}px`,top:`${p-e.height/2}px`,zIndex:String(o.globalIndex),display:"block"},Object.assign(g.style,t),o.trailImageTimestamps.set(g,Date.now()),h.default.fromTo(g,{autoAlpha:0,scale:.8},{scale:1,autoAlpha:1,duration:.2,overwrite:!0}),o.last={x:f,y:p},o.globalIndex>=n){let e=(o.globalIndex-n+i.length)%i.length,t=i[e];t&&s(t)}o.globalIndex++}},c=()=>{let e=Date.now();for(let[t,i]of o.trailImageTimestamps.entries())e-i>r.stopDuration&&(s(t),o.trailImageTimestamps.delete(t))},u=()=>{if(o.isActive){for(let t of(o.isActive=!1,e.removeEventListener("mousemove",l),o.trailInterval&&(clearInterval(o.trailInterval),o.trailInterval=null),i))s(t);o.trailImageTimestamps.clear()}},d=()=>{window.innerWidth<r.minWidth&&o.isActive&&u()};return window.addEventListener("resize",d),{start:()=>{if(!o.isActive&&!(window.innerWidth<r.minWidth)){for(let e of i)a.set(e,{width:e.offsetWidth,height:e.offsetHeight});o.isActive=!0,e.addEventListener("mousemove",l),o.trailInterval=setInterval(c,100)}},stop:u,destroy:()=>{u(),window.removeEventListener("resize",d)}}})(e);if(!t)return;let r=()=>{let e=(0,n.getIntroOutroSegmentProgress)(E(w()))>=.95;S(t=>t===e?t:e),e?t.start():t.stop()};r();let i=x(r);return()=>{i(),t.destroy()}},d=[E,w,I,y,x],m[6]=E,m[7]=w,m[8]=I,m[9]=y,m[10]=x,m[11]=u,m[12]=d):(u=m[11],d=m[12]),(0,a.useEffect)(u,d),!A.length||y)?null:(m[13]!==A?(f=A.map(B),m[13]=A,m[14]=f):f=m[14],m[15]!==f?(p=(0,t.jsx)(M,{className:"trail-list",children:f}),m[15]=f,m[16]=p):p=m[16],m[17]!==T||m[18]!==p?(g=(0,t.jsx)(D,{ref:$,"data-trail":"wrapper",$isActive:T,"aria-hidden":"true",children:p}),m[17]=T,m[18]=p,m[19]=g):g=m[19],g)};function U(e){return(0,L.resolveImageWithAlt)(e)}function G(e){return!!e}function F(e){return e.src}function B(e){return(0,t.jsx)(N,{"data-trail":"item",children:(0,t.jsx)(H,{src:(0,P.imageRenditionSrc)(e.image,"trail")??void 0,alt:e.alt,width:e.width,height:e.height,draggable:!1,loading:"lazy",decoding:"async"})},e.src)}z.displayName="ImageTrail";var W=e.i(221781),V=e.i(486861),X=e.i(189897),q=e.i(875324),Y=e.i(797489),J=e.i(274879);let K=e=>{if(!e.length)return;let t=1/0,r=1/0,i=-1/0,n=-1/0;for(let o of e){let e=o.offsetLeft,a=o.offsetTop,s=e+o.offsetWidth,l=a+o.offsetHeight;t=Math.min(t,e),r=Math.min(r,a),i=Math.max(i,s),n=Math.max(n,l)}let o=(t+i)/2,a=(r+n)/2;for(let t of e)h.default.set(t,{transformOrigin:`${o-t.offsetLeft}px ${a-t.offsetTop}px`,force3D:!0})},Z=e=>{h.default.set(e,{autoAlpha:0,scale:W.TITLE_SCALE_START,yPercent:0,filter:`blur(${W.TITLE_BLUR_START}px)`,display:"inline-block",verticalAlign:"top",willChange:"opacity, transform, filter"})},Q=e=>{h.default.set(e,{autoAlpha:1,scale:1,yPercent:0,filter:"blur(0px)",display:"inline-block",verticalAlign:"top",willChange:"auto"})},ee=e=>{let o,s,c,u,d,f,g,m,v,y,w,x,E=(0,r.c)(40),{heading:$,editAttr:T}=e,{isReducedMotion:S}=(0,a.use)(l.PerformanceContext),{getProgress:_,subscribe:R,getIntroSegmentProgress:j,getApproachEntryProgress:k}=(0,i.useStickyTrackStore)(),C=(0,b.useIsDesktopViewport)(),L=(0,a.useRef)(null),P=(0,a.useRef)(null);E[0]===Symbol.for("react.memo_cache_sentinel")?(o=[],E[0]=o):o=E[0];let O=(0,a.useRef)(o),D=(0,a.useRef)("hidden"),M=(0,a.useRef)(-1),N=(0,a.useRef)(-1);if(E[1]!==$?.line1||E[2]!==$?.line2){let e=(0,X.cleanSanityString)($?.line1),t=(0,X.cleanSanityString)($?.line2);s=!!(e||t),c=`${e}|${t}`,f=Y.useInnerHtml,u=(0,V.escapeHtml)(e),d=(0,V.escapeHtml)(t),E[1]=$?.line1,E[2]=$?.line2,E[3]=s,E[4]=c,E[5]=u,E[6]=d,E[7]=f}else s=E[3],c=E[4],u=E[5],d=E[6],f=E[7];E[8]!==u||E[9]!==d?(g=[u,d].filter(Boolean),E[8]=u,E[9]=d,E[10]=g):g=E[10];let H=f(g.join("<br />")),z=(0,J.useSplitTextRecovery)(L,c);return(E[11]!==s||E[12]!==S?(m=()=>{if(!L.current||!s)return;let e=q.SplitText.create(L.current,{type:"words"}),{words:t}=e;return(O.current=t,D.current="hidden",M.current=-1,t.length)?(h.default.set(L.current,{autoAlpha:1}),S)?(Q(t),()=>e.revert()):(K(t),Z(t),()=>e.revert()):()=>e.revert()},E[11]=s,E[12]=S,E[13]=m):m=E[13],E[14]!==s||E[15]!==c||E[16]!==S||E[17]!==z?(v={scope:L,dependencies:[s,c,S,z]},E[14]=s,E[15]=c,E[16]=S,E[17]=z,E[18]=v):v=E[18],(0,p.useAnimation)(m,v),E[19]!==k||E[20]!==j||E[21]!==_||E[22]!==s||E[23]!==C||E[24]!==S||E[25]!==R?(y=()=>{if(!s||S)return;let e=()=>{let e=O.current,t=P.current;if(!e.length||!L.current||!t)return;let r=.002*Math.round((0,n.getIntroOutroSegmentProgress)(j(_()))/.002),i=.002*Math.round(k()/.002);if(C&&i>0){let e;if(i===N.current)return;N.current=i;let{opacity:r,blur:n}={opacity:1-(e=Math.min(1,Math.max(0,i)/.7)),blur:12*e};h.default.set(t,{autoAlpha:r,filter:`blur(${n}px)`,willChange:"opacity, filter"});return}if(-1!==N.current&&(N.current=-1,h.default.set(t,{autoAlpha:1,filter:"blur(0px)",willChange:"auto"})),r<=0){"hidden"!==D.current&&(h.default.set(t,{y:0,willChange:"auto"}),Z(e),D.current="hidden",M.current=-1);return}if(r>=1){"visible"!==D.current&&(h.default.set(t,{y:0,willChange:"auto"}),K(e),Q(e),D.current="visible",M.current=1);return}if("animating"===D.current&&r===M.current)return;let o="animating"!==D.current;for(let[i,n]of(D.current="animating",M.current=r,o&&(h.default.set(t,{y:0,willChange:"auto"}),K(e)),e.entries())){let{scale:t,opacity:o,blur:a}=(0,W.getIntroGrowInWordValues)(r,i,e.length);h.default.set(n,{autoAlpha:o,scale:t,yPercent:0,filter:`blur(${a}px)`})}};return e(),R(e)},E[19]=k,E[20]=j,E[21]=_,E[22]=s,E[23]=C,E[24]=S,E[25]=R,E[26]=y):y=E[26],E[27]!==k||E[28]!==j||E[29]!==_||E[30]!==s||E[31]!==C||E[32]!==S||E[33]!==z||E[34]!==R?(w=[k,j,_,s,C,S,R,z],E[27]=k,E[28]=j,E[29]=_,E[30]=s,E[31]=C,E[32]=S,E[33]=z,E[34]=R,E[35]=w):w=E[35],(0,a.useEffect)(y,w),s)?(E[36]!==T||E[37]!==H||E[38]!==c?(x=(0,t.jsx)(A,{ref:P,children:(0,t.jsx)(I,{ref:L,"data-sanity":T,dangerouslySetInnerHTML:H},c)}),E[36]=T,E[37]=H,E[38]=c,E[39]=x):x=E[39],x):null};ee.displayName="IntroductionHeading";let et=e=>{let s,l,c,u,d,f,p,h,g,m=(0,r.c)(25),{heading:v,desktopVideoSrc:b,mobileVideoSrc:y,gallery:w,scrollLength:x,documentId:E,documentType:T}=e,S=void 0===x?n.DEFAULT_INTRO_SCROLL_LENGTH:x,{setIntroScrollLength:A,getProgress:I,subscribe:_,getIntroSegmentProgress:R}=(0,i.useStickyTrackStore)(),[k,C]=(0,a.useState)(!1);m[0]!==S||m[1]!==A?(s=()=>(A(S),()=>{A(n.DEFAULT_INTRO_SCROLL_LENGTH)}),l=[S,A],m[0]=S,m[1]=A,m[2]=s,m[3]=l):(s=m[2],l=m[3]),(0,a.useLayoutEffect)(s,l),m[4]!==R||m[5]!==I||m[6]!==_?(c=()=>{let e=()=>{let e=(0,n.getIntroOutroSegmentProgress)(R(I()))>0;C(t=>t===e?t:e)};return e(),_(e)},u=[R,I,_],m[4]=R,m[5]=I,m[6]=_,m[7]=c,m[8]=u):(c=m[7],u=m[8]),(0,a.useEffect)(c,u),m[9]!==E||m[10]!==T?(d=(0,o.sanityEditAttr)({id:E,type:T,path:"introductionHeading"}),m[9]=E,m[10]=T,m[11]=d):d=m[11];let L=d;m[12]!==b||m[13]!==y?(f=(0,t.jsx)(j,{desktopVideoSrc:b,mobileVideoSrc:y}),m[12]=b,m[13]=y,m[14]=f):f=m[14];let P=w??void 0;m[15]!==P?(p=(0,t.jsx)(z,{images:P}),m[15]=P,m[16]=p):p=m[16];let O=v??void 0;return m[17]!==L||m[18]!==O?(h=(0,t.jsx)(ee,{heading:O,editAttr:L}),m[17]=L,m[18]=O,m[19]=h):h=m[19],m[20]!==k||m[21]!==h||m[22]!==f||m[23]!==p?(g=(0,t.jsxs)($,{$elevated:k,children:[f,p,h]}),m[20]=k,m[21]=h,m[22]=f,m[23]=p,m[24]=g):g=m[24],g};et.displayName="Introduction",e.s(["default",0,et],958643)},375476,e=>{"use strict";var t=e.i(843476),r=e.i(500932),i=e.i(271645),n=e.i(575509),o=e.i(997053);let a=(0,o.default)(n.Div).attrs({as:"section"}).withConfig({componentId:"sc-6db9e853-0"})(({$isInView:e=!1})=>o.css`
        --gap: ${(0,n.getGap)("xxl")};
        --speed: 20s;
    ...
    `),E=(0,h.default)(f.Div).attrs({as:"picture"}).withConfig({componentId:"sc-ec8dda4b-7"})(()=>h.css`
        display: block;
        position: relative;
	...
	`),T=(0,E.default)(w.Div).withConfig({componentId:"sc-d69e8bb7-1"})(({theme:e})=>E.css`
		display: none;
		...
		${w.bp.l`		
			...
			height: 100%;
		`}
	`),S=(0,E.default)(w.Div).withConfig({componentId:"sc-d69e8bb7-2"})(()=>E.css`
		position: relative;
		...
		${w.bp.l`
			...
			aspect-ratio: 2 / 3;
		`}
	`),A=(0,E.default)(w.Div).attrs({as:"picture"}).withConfig({componentId:"sc-d69e8bb7-3"})(()=>E.css`
		position: relative;
	...
	`),I=(0,E.default)(w.Div).attrs({as:"h2"}).withConfig({componentId:"sc-d69e8bb7-4"})(()=>E.css`
		${x.headlineS}
		position: relative;
		z-index: 1;
		text-wrap: balance;
		...
		${w.bp.l`
			margin-bottom: 0;
		`}
	`),_=(0,E.default)(w.Div).withConfig({componentId:"sc-d69e8bb7-5"})(()=>E.css`
		position: relative;
		z-index: 1;
		...
		`}
	`),R=(0,E.default)(w.Div).attrs({as:"p"}).withConfig({componentId:"sc-d69e8bb7-6"})(()=>E.css`
		${x.bodyL}
	...
	`),b=d.default.div.withConfig({componentId:"sc-2b3d2147-5"})(()=>d.css`
		...
		width: 100%;
		height: 100dvh;
	`),y=({children:e,overlay:u})=>{let{lenisRef:d}=(0,s.use)(r.AppContext),{isReducedMotion:y}=(0,s.use)(i.PerformanceContext),w=(0,s.useRef)(null),x=(0,s.useRef)(null),E=(0,s.useRef)(null),$=(0,s.useRef)(null),T=(0,s.useRef)(0),S=(0,s.useRef)(0),A=(0,s.useRef)(c.DEFAULT_INTRO_SCROLL_LENGTH),I=(0,s.useRef)(c.DEFAULT_HERO_TEXT_SCROLL_LENGTH),_=(0,s.useRef)(new Set),R=(0,s.useRef)(null),j=(0,s.useRef)(0),k=(0,s.useRef)(0),C=(0,s.useRef)(0),L=(0,s.useRef)(0),P=(0,s.useRef)(0),[O,D]=(0,s.useState)(c.DEFAULT_INTRO_SCROLL_LENGTH),M=(0,s.useCallback)(()=>{P.current||(P.current=window.requestAnimationFrame(()=>{for(let e of(P.current=0,_.current))e()}))},[]),N=(0,s.useCallback)(()=>T.current,[]),H=(0,s.useCallback)(()=>S.current,[]),z=(0,s.useCallback)(e=>(_.current.add(e),()=>{_.current.delete(e)}),[]),U=(0,s.useCallback)(e=>{let t=Math.min(1,Math.max(0,e));5e-4>Math.abs(T.current-t)||(T.current=t,M())},[M]),G=(0,s.useCallback)(()=>A.current,[]),F=(0,s.useCallback)(e=>{let t=Math.max(.1,e);if(A.current!==t){for(let e of(A.current=t,D(t),_.current))e();requestAnimationFrame(()=>{R.current?.()})}},[]),B=(0,s.useCallback)(()=>I.current,[]),W=(0,s.useCallback)(e=>{let t=Math.max(.1,e);if(I.current!==t)for(let e of(I.current=t,_.current))e()},[]),V=(0,s.useCallback)((e=T.current)=>(0,c.getIntroSegmentProgress)(e,A.current,c.DEFAULT_HERO_SCROLL_LENGTH),[]),X=(0,s.useCallback)((e=T.current)=>(0,c.getHeroTextSegmentProgress)(e,A.current,c.DEFAULT_HERO_SCROLL_LENGTH,I.current),[]),q=(0,s.useCallback)(()=>(0,c.getTrackScrollLength)(A.current,c.DEFAULT_HERO_SCROLL_LENGTH),[]);(0,s.useEffect)(()=>{var e;let t,r,i,s=w.current,l=x.current,u=E.current;if(!s||!l||!u)return;let f=!1,h=null,g=[],m=window.matchMedia(n.DESKTOP_MEDIA_QUERY),v=window.matchMedia(p),b=()=>{for(let e of g)e();g=[]},T=()=>{if(!h)return;b();let e=e=>Math.ceil((0,c.getScrollFromTrackProgress)(e,j.current,k.current,L.current));g=[h.add(e((0,c.getIntroCompleteTrackProgress)(A.current))),h.add(e(1))],h.resize()},I=()=>{b(),h?.destroy(),h=null},_=()=>{I();let e=d.current?.lenis;e&&m.matches&&!y&&((h=new a.default(e,{type:"proximity",debounce:500,duration:c.INTRO_SNAP_DURATION})).stop(),T())},O=e=>{if(f!==e){if(f=e,e){l.style.position="fixed",l.style.top="0",l.style.left="0",l.style.width="100%",l.style.height="100dvh",l.style.zIndex="1";return}l.style.removeProperty("position"),l.style.removeProperty("top"),l.style.removeProperty("left"),l.style.removeProperty("width"),l.style.removeProperty("height"),l.style.removeProperty("z-index")}},D=e=>{if(y||m.matches||e<=0)return void l.style.removeProperty("--panel-fade");let t=Math.min(1,e/.85);l.style.setProperty("--panel-fade",`${Math.round(1e3*t)/1e3}`)},N=()=>{let e=$.current;e&&(e.style.removeProperty("clip-path"),e.style.removeProperty("transform"))},H=e=>{let t=$.current;if(!t)return;if(y||!m.matches||e>=.9995)return void N();let r=1-e;t.style.transform=`translate3d(0, ${-r*L.current}px, 0) scale(${1+.2*r})`,t.style.clipPath=`inset(${50*r}% ${50*r}%)`},z=()=>{let e=d.current?.lenis;if(!e)return;let t=e.scroll,r=j.current,i=r+C.current-L.current;O(t>=r&&t<i&&!v.matches);let n=(0,c.measureStickyTrackProgressFromScroll)(t,r,k.current,L.current);U(n);let o=(0,c.getApproachEntryProgress)(t,r,k.current,L.current);h&&!y&&m.matches?(0,c.getIntroSegmentProgress)(n,A.current,c.DEFAULT_HERO_SCROLL_LENGTH)>=c.INTRO_SNAP_VIDEO_THRESHOLD&&n<1||o>0&&o<c.APPROACH_SNAP_BACK_THRESHOLD?h.start():h.stop():h?.stop(),Math.abs(S.current-o)>=5e-4&&(S.current=o,H(o),D(o),M())},G=(e=()=>{o.default.refresh()},r=0,(i=(...t)=>{window.clearTimeout(r),r=window.setTimeout(()=>e(...t),150)}).cancel=()=>{window.clearTimeout(r)},i),F=()=>{let e;e=d.current?.lenis?.rootElement?.clientHeight??window.innerHeight,j.current=s.offsetTop,k.current=u.offsetHeight+e,C.current=s.offsetHeight,L.current=e,T(),z(),H(S.current),D(S.current),G()};R.current=F,F();let B=window.setTimeout(F,300),W=()=>F(),V=0,X=()=>{if(y)return;let e=d.current?.lenis;if(!e){V=window.requestAnimationFrame(X);return}t=z,e.on("scroll",t),_(),F()};X();let q=()=>{_(),F()};m.addEventListener("change",q);let Y=()=>{O(!1),F()};v.addEventListener("change",Y);let J=new ResizeObserver(F);return J.observe(s),window.addEventListener("load",W),window.addEventListener("resize",F),()=>{R.current=null,G.cancel(),window.cancelAnimationFrame(V),window.cancelAnimationFrame(P.current),P.current=0,window.clearTimeout(B),window.removeEventListener("load",W),window.removeEventListener("resize",F),m.removeEventListener("change",q),v.removeEventListener("change",Y),J.disconnect(),t&&d.current?.lenis?.off("scroll",t),I(),O(!1),N(),l.style.removeProperty("--panel-fade")}},[y,d,M,U]);let Y=(0,s.useMemo)(()=>({getProgress:N,subscribe:z,getIntroScrollLength:G,setIntroScrollLength:F,getHeroTextScrollLength:B,setHeroTextScrollLength:W,getIntroSegmentProgress:V,getApproachEntryProgress:H,getHeroTextSegmentProgress:X,getTrackScrollLength:q}),[B,G,N,H,X,V,q,W,F,z]),J=(0,c.getTrackScrollLength)(O,c.DEFAULT_HERO_SCROLL_LENGTH);return(0,t.jsx)(l.StickyTrackContext.Provider,{value:Y,children:(0,t.jsxs)(f,{ref:w,children:[(0,t.jsx)(h,{children:(0,t.jsx)(g,{ref:x,children:e})}),(0,t.jsx)(m,{ref:E,$scrollLength:J}),u?(0,t.jsx)(v,{children:(0,t.jsx)(b,{ref:$,children:u})}):null]})})};y.displayName="StickyTrack",e.s(["default",0,y],229287)},867308,e=>{"use strict";let t=0,r=2,i=.6,n=.4,o=(e=r,i=t,o=n)=>i+e+o;e.s(["APPROACH_HOLD_PX",0,100,"APPROACH_SNAP_BACK_THRESHOLD",0,.5,"DEFAULT_HERO_SCROLL_LENGTH",0,t,"DEFAULT_HERO_TEXT_SCROLL_LENGTH",0,i,"DEFAULT_INTRO_SCROLL_LENGTH",0,r,"INTRO_SNAP_DURATION",0,2,"INTRO_SNAP_VIDEO_THRESHOLD",0,.6,"getApproachEntryProgress",0,(e,t,r,i)=>i<=0?0:Math.min(1,Math.max(0,(e-(t+r-i))/i)),"getHeroTextSegmentProgress",0,(e,a=r,s=t,l=i)=>{let c=o(a,s),u=((e=r,i=t,a=n)=>Math.max(o(e,i,a)-1,0))(a,s);return u<=0||l<=0?0:Math.max(0,Math.min(1,Math.max(0,e-s/c)/(l/u)))},"getIntroCompleteTrackProgress",0,(e=r,i=t,a=n)=>{let s=o(e,i,a);return s<=0?0:Math.min(1,(i+e)/s)},"getIntroOutroSegmentProgress",0,e=>e<=.5?0:Math.min(1,(e-.5)/.5),"getIntroSegmentProgress",0,(e,i=r,n=t)=>{let a=o(i,n);return a<=0?0:Math.max(0,Math.min(1,(e-n/a)/(i/a)))},"getScrollFromTrackProgress",0,(e,t,r,i)=>{let n=r-i;return n<=0?t:t+Math.min(1,Math.max(0,e))*n},"getTrackScrollLength",0,o,"measureStickyTrackProgressFromScroll",0,(e,t,r,i)=>{let n=r-i;return n<=0?0:Math.min(1,Math.max(0,(e-t)/n))},"shouldPauseHeroPlayback",0,e=>e>.002])},115166,e=>{"use strict";var t=e.i(843476),r=e.i(500932),i=e.i(481293);let n=(e,t)=>r=>{r instanceof HTMLElement&&(e.current[t]=r)};var o=e.i(992325),a=e.i(607561),s=e.i(494473),l=e.i(989970),c=e.i(883495),u=e.i(255667),d=e.i(815711),f=e.i(328852),p=e.i(271645),h=e.i(575509),g=e.i(212960),m=e.i(997053);let v="100dvh",b=(0,m.default)(h.Div).attrs({as:"section"}).withConfig({componentId:"sc-3a017878-0"})(()=>m.css`	
        position: relative;
		z-index: 5;
	...
	`),E=(0,m.default)(h.Div).withConfig({componentId:"sc-3a017878-4"})(()=>m.css`
        position: relative;
        z-index: 2;
    `),$=(0,m.default)(h.Div).attrs({as:"aside"}).withConfig({componentId:"sc-3a017878-5"})(()=>m.css`
        display: none;
    ...
    `),T=(0,m.default)(h.Div).withConfig({componentId:"sc-3a017878-6"})(()=>m.css`
        ...
        align-items: center;
        justify-content: center;
    `),S=(0,m.default)(h.Div).withConfig({componentId:"sc-3a017878-7"})(()=>m.css`
        position: relative;
        width: 100%;
        aspect-ratio: 1/1;
